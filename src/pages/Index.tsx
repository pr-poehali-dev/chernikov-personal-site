...
export default function Index() {
  const courses = [
    ...
    {
      title: "Бесплатный МК по ИИ",
      description: "Нейросети для бизнеса, продвижения и заработка",
      price: "Бесплатно",
      features: ["Всё для уверенного старта в ChatGPT, Midjourney и ещё 7 актуальных нейросетях", "Готовые запросы для нейросетей под ваши задачи: от постов для соцсетей до разработки бизнес-стратегии", "Понятный алгоритм заработка на нейросетях, который можно применить сразу после мастер-класса", "Лучшие кейсы использования AI в бизнесе, маркетинге и творчестве"],
      link: "https://copy-site-13onlinekurs--preview.poehali.dev/?clckid=be7ef9da"
    },
    {
